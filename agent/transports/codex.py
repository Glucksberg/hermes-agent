...
def _openai_responses_supports_reasoning_state(model: str) -> bool:
    """Return True for OpenAI Responses models that accept reasoning state."""
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def convert_messages(self, messages: List[Dict[str, Any]], **kwargs) -> Any:
        ...
        return _chat_messages_to_responses_input(
            ...
            replay_reasoning_items=bool(kwargs.get("replay_reasoning_items", True)),
        )
    ...
    def build_kwargs(
        ...
        **params,
        ...
        supports_reasoning_state = (
            is_xai_responses
            or is_codex_backend
            or _openai_responses_supports_reasoning_state(model)
        )
        ...
        kwargs = {
            ...
            "input": _chat_messages_to_responses_input(
                ...
                replay_reasoning_items=supports_reasoning_state,
            ),
