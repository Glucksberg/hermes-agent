...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    replay_reasoning_items: bool = True,
) -> List[Dict[str, Any]]:
    ...
    ``replay_reasoning_items`` lets callers suppress encrypted reasoning
    replay for non-reasoning Responses models such as gpt-4o, which reject
    reasoning state even though they can use the Responses API for normal
    text/tool calls.
    """
    ...
    for msg in messages:
        ...
        if role in {"user", "assistant"}:
            ...
            if role == "assistant":
                ...
                if replay_reasoning_items and isinstance(codex_reasoning, list):
